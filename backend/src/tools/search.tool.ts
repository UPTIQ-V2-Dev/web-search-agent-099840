...
const performWebSearchTool: MCPTool = {
    id: 'search_web',
...
const getSearchSuggestionsTool: MCPTool = {
...
const getUserSearchHistoryTool: MCPTool = {
...
const saveSearchToHistoryTool: MCPTool = {
...
const clearSearchHistoryTool: MCPTool = {
...
const deleteSearchHistoryItemTool: MCPTool = {
...
const getUserSearchStatsTool: MCPTool = {
...
const getSystemSearchStatsTool: MCPTool = {
...
const clearExpiredCacheTool: MCPTool = {
