import { searchController } from '../../controllers/index.ts';
import auth from '../../middlewares/auth.ts';
import validate from '../../middlewares/validate.ts';
import { searchValidation } from '../../validations/index.ts';
...
router.get(
    '/suggestions',
    auth('search'),
    validate(searchValidation.searchSuggestions),
...
router
    ...
    .delete(
        auth('search'),
        validate(searchValidation.deleteSearchHistoryItem),
